...
// update self-updates the gsheets binary by cloning the latest source from GitHub,
...
const repoURL = "https://github.com/the20100/gsheets-cli"

var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update gsheets to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "gsheets-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "gsheets")
